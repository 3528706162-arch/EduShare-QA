  ...
  <div class="home-container">
    ...
    <div class="features-section">
      <div class="section-header">
        ...
        <p class="section-subtitle">为师生提供全方位的学习支持</p>
      </div>
      ...
      <div class="features-grid">
        <div class="feature-card" @click="navigateToResources">
          ...
          <h3>学习资源库</h3>
          <p>海量课程资料、课件、习题库，按专业分类，支持搜索和下载</p>
          <div class="feature-stats">
            <span>资源总数：{{ resourceStats.total || '加载中...' }}</span>
          </div>
        </div>
        ...
        <div class="feature-card" @click="navigateToQuestions">
          ...
          <h3>问答社区</h3>
          <p>师生互动交流，快速解决学习难题，支持问题悬赏和最佳答案</p>
          <div class="feature-stats">
            <span>活跃问题：{{ questionStats.active || '加载中...' }}</span>
          </div>
        </div>
